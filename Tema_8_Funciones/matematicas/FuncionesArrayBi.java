...
public class FuncionesArrayBi {
  ...
  /**
   * Muestra por pantalla todos los elementos de un array bidimensional de números enteros
   * separados por un espacio y salto de línea según la fila.
   * 
